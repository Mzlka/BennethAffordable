...
document.addEventListener("DOMContentLoaded", () => {
   ...
   */
  const counters = [
    { id: "activeAgent", endVal: 500, suffix: "+" },
    { id: "clientSatisfaction", endVal: 98, suffix: "%" },
    { id: "propertyListings", endVal: 150, suffix: "+" },
  ];
  ...
  if (section) {
    ...
    }, { threshold: 0.5 }); // CUSTOMIZATION: Adjust how much of the section must be visible
